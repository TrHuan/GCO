...
jQuery(document).ready(function($) {
    ...
    ////////////////////
    var hg_pop = $('.art-popups-oder .popups-box').height();
    var hg_win = $(window).height();
    if (hg_pop > hg_win) {
        $('.art-popups-oder .popups-box').css({'top': '10px'});        
        $('.art-popups-oder .popups-box').height(hg_win - 20);
    } else {
        $('.art-popups-oder .popups-box').css({'top': 'auto'});        
        $('.art-popups-oder .popups-box').height('auto');
    }
    ////////////////////
